...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#b4ecff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#aa8929", textDisabled: "#BDC2C4", textSubtle: "#694d25", borderColor: "#E9EAEB", card: "#FFFFFF", modal: "#524B63", nav: "#9bd9ff", gradients: {
