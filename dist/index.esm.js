...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#b4ecff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#E0115F", textDisabled: "#BDC2C4", textSubtle: "#843F5B", borderColor: "#E9EAEB", card: "#FFFFFF", modal: "#FFFFFF", nav: "#9bd9ff", gradients: {
